...
# Form implementation generated from reading ui file '/home/yannick/Programmieren/80_Github/ectec/python/ectec-gui/res/clientUser.ui'
#
...
class Ui_dUserClient(object):
    def setupUi(self, dUserClient):
        ...
        self.labelClientAddress.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.labelClientName.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.labelServerAddress.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.labelServerPort.setFrameShadow(QtWidgets.QFrame.Raised)
    ...
    def retranslateUi(self, dUserClient):
        ...
        self.labelClientAddress.setText(_translate("dUserClient", "127.0.0.1"))
        self.labelClientName.setText(_translate("dUserClient", "user1"))
        self.labelServer.setText(_translate("dUserClient", "<html><head/><body><p><span style=\" font-style:italic;\">Server</span></p></body></html>"))
        self.labelServerAddress.setText(_translate("dUserClient", "197.12.45.23"))
        self.labelServerPort.setText(_translate("dUserClient", "50000"))
